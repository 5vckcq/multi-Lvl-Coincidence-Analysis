...
\begin{tikzpicture}[>=latex,%
  ...
  crelationleft/.style={densely dotted,opacity=0.6,in=180,out=120},% Linienstil linksumschliessende Konstitutionsbeziehung
  crelationright/.style={densely dotted,opacity=0.6,in=0,out=60},% Linienstil rechtsumschliessende Konstitutionsbeziehung
