...
\begin{tikzpicture}[>=latex,%
  ...
  crelationleft/.style={densely dotted,opacity=0.6,in=180,out=180},% Linienstil linksumschliessende Konstitutionsbeziehung
  crelationright/.style={densely dotted,opacity=0.6,in=0,out=0},% Linienstil rechtsumschliessende Konstitutionsbeziehung
