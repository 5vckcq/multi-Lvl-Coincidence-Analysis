...
cnames <- c("A","B","C","D","E","F","G","H","J","P") # column names = names of causal factors

data_set <- array(0, dim=c(9,10),dimnames=list(rnames,cnames)) # a table of 9 rows and 10 columns each referenced by the entries in 
# rnames and cnames
